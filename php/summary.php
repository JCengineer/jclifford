<div id="summary">
	<div id="gallery" class="gallery">
		...
		<div id="galleryscroller" class="scrollerdiv">
			...
			<!--jclifford-->
			<div image='background-image:url("media/gallery/jclifford.png");' id="headerPic1" class="image"  
								        href="media/gallery/jclifford.png" title="This website uses raw PHP, HTML5, Javascript (jQuery, AJAX) and CSS3."></div>
			<div image='background-image:url("media/gallery/jclifford2.png");' id="headerPic2" class="image"  
			...
			<!--visilit-->
			<div image='background-image:url("media/gallery/visilitDemo.jpg");' id="headerPic3" class="image"  
					 			        href="media/gallery/visilitDemo.jpg" title="VisiLit Virtual Venue - event builder page, where events can be created."></div>
			<div image='background-image:url("media/gallery/stage.jpg");' id="headerPic3" class="image"  
					 			        href="media/gallery/stage.jpg" title="This is a screenshot of the VisiLit Virtual Venue 3D visualisation."></div>
			<div image='background-image:url("media/gallery/visilit.jpg");' id="headerPic3" class="image"  
					 			        href="media/gallery/visilit.jpg" title="The VisiLit landing page."></div>
			<div image='background-image:url("media/gallery/visilitSales.jpg");' id="headerPic3" class="image"  
			...
			<!--andorra-->
			<div image='background-image:url("media/gallery/andorrabb.jpg");' id="headerPic3" class="image"  
					 			        href="media/gallery/andorrabb.jpg" title="This website was built for a guesthouse."></div>
			<div image='background-image:url("media/gallery/andorrabbContent.jpg");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/andorrabbMobile.jpg");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/ck1.png");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/ck2.png");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/gs1.png");' id="headerPic3" class="image"  
					 			        href="media/gallery/gs1.png" title="Gigstarter is a crowd sourcing platform for events, encouraging viral customer activity."></div>
			<div image='background-image:url("media/gallery/gs2.png");' id="headerPic3" class="image"  
					 			        href="media/gallery/gs2.png" title="As Chief Technical Officer, my role is to manage and direct all development of the products and services."></div>
			
			<div image='background-image:url("media/gallery/nm.png");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/liveroom.png");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/cloudm.jpg");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/compm.jpg");' id="headerPic3" class="image"  
					 			        href="media/gallery/compm.jpg" title="computer technician / maintenance / administration."></div>
			<div image='background-image:url("media/gallery/matrix.jpg");' id="headerPic3" class="image"  
			...
			-->
			<div image='background-image:url("media/gallery/1switch.jpg");' id="headerPic5" class="image"  
			...
			<div image='background-image:url("media/gallery/c2l.jpg");' id="headerPic6" class="image"  
			...
			<div image='background-image:url("media/gallery/rpi.jpg");' id="headerPic6" class="image"  
			...
			<div image='background-image:url("media/gallery/chip.jpg");' id="headerPic6" class="image"  
			...
			<div image='background-image:url("media/gallery/audiosetup.jpg");' id="headerPic1" class="image"  
			...
			<div image='background-image:url("media/gallery/repaireq.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/tools.jpg");' id="headerPic2" class="image"  
					 			        href="media/gallery/tools.jpg" title="While most of my experience is engineering related, I have had the pleasure of working with and advising startups, receiving support from investors and state bodies etc."></div>
			<div image='background-image:url("media/gallery/JamesV.jpg");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/pyramid.jpg");' id="headerPic3" class="image"  
			...
			<div image='background-image:url("media/gallery/gear.jpg");' id="headerPic4" class="image"  
					 			        href="media/gallery/gear.jpg" title="I ran a previous business, built up over the years as a sound engineer and technician working in the events industry. I once owned, leased and operated technical event equipment from microphones, mixing desks, PA speakers, lights, monitors, communications, staging etc."></div>
			<div image='background-image:url("media/gallery/panto1.jpg");' id="headerPic5" class="image"  
			...
			<div image='background-image:url("media/gallery/wanderlust.jpg");' id="headerPic6" class="image"  
			...
			<div image='background-image:url("media/gallery/confex1.jpg");' id="headerPic7" class="image"  
					 			        href="media/gallery/confex1.jpg" title="For a particular conference, my job was to fit an attractive looking stand into a two metre by 1 metre exhibition space. I built the furniture and fittings to suit the offering."></div>
			<div image='background-image:url("media/gallery/confex4.jpg");' id="headerPic8" class="image"  
					 			        href="media/gallery/confex4.jpg" title="People were actually coming to us to congratulate us on the stand. After all, if you're selling software, you don't need acres of space to give a five minute demonstration!"></div>
			<div image='background-image:url("media/gallery/ballet1.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/ballet2.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/tap1.jpg");' id="headerPic7" class="image"  
					 			        href="media/gallery/tap1.jpg" title="Then there's the tap board / sand dance box that we worked on!"></div>
			<div image='background-image:url("media/gallery/tap2.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/tap3.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/tap4.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/breakables1.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/case1.jpg");' id="headerPic7" class="image"  
					 			        href="media/gallery/case1.jpg" title="2 guitarists needed cost effective flightcases for their guitar amps so I build some. part 1/3"></div>
			<div image='background-image:url("media/gallery/case2.jpg");' id="headerPic7" class="image"  
					 			        href="media/gallery/case2.jpg" title="2 guitarists needed cost effective flightcases for their guitar amps so I build some. part 2/3"></div>
			<div image='background-image:url("media/gallery/case4.jpg");' id="headerPic7" class="image"  
					 			        href="media/gallery/case4.jpg" title="2 guitarists needed cost effective flightcases for their guitar amps so I build some. part 3/3"></div>
			
			<div image='background-image:url("media/gallery/s1.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s2.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s3.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s4.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s5.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s5a.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s5b.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s6.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s7.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s8.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s9.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s10.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s11.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s12.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s13.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s14.jpg");' id="headerPic7" class="image"  
			...
			<div image='background-image:url("media/gallery/s15.jpg");' id="headerPic7" class="image"  
