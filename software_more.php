...
<?php if (!$fromAjax) startPage(); ?>
	...
	<br>
	From my work in VisiLit, I used PHP, HTML5, CSS3 and Javascript coding languages with MySQL database management for the web development aspect of the project.
	...
	<br><br>
	GigStarter hired me to be CTO and broaden the scope of their crowd funding platform for events and assist in event management at <a href="gigstarter.com" target="_blank">gigstarter.com</a>.
	These included:
	...
	<br><br>
	Love&Robots hired me to be their CTO and develop their interactive and personalised 3D printed products at <a href="loveandrobots.com" target="_blank">loveandrobots.com</a>.
	These included:
	<li>THREEJS / WebGL</li>
	<li>HTML5 / JavaScript</li>
	<li>SASS / CSS</li>
	<li>Ruby on Rails</li>
	<li>Linux server administration on Microsoft Azure.</li>
